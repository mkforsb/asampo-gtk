...
macro_rules! delegate {
    ($subm:ident, $fname:ident ($($param0:ident: $tp0:ident $(, $param:ident: $tp:ty)*)?) -> Result) => {
    ...
    ($subm:ident, $fname:ident ($($param0:ident: $tp0:ident $(, $param:ident: $tp:ty)*)?) -> Model) => {
    ...
    ($subm:ident, $fname:ident ($($param0:ident: $tp0:ident $(, $param:ident: $tp:ty)*)?) -> $rt:ty) => {
        pub fn $fname(&self $(, $param0: $tp0 $(, $param: $tp)*)?) -> $rt {
            self.$subm.$fname($($param0 $(, $param)*)?)
        }
    };
    ($subm:ident, $fname:ident ($($param0:ident: $tp0:ident $(, $param:ident: $tp:ty)*)?) as $name:ident -> Result) => {
    ...
    ($subm:ident, $fname:ident ($($param0:ident: $tp0:ident $(, $param:ident: $tp:ty)*)?) as $name:ident -> Model) => {
    ...
    ($subm:ident, $fname:ident ($($param0:ident: $tp0:ident $(, $param:ident: $tp:ty)*)?) as $name:ident -> $rt:ty) => {
